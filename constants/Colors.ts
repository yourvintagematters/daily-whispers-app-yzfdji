...
export const DAILY_WHISPERS_THEMES = {
  ...
  aDogsLife: {
    ...
    buttonColor: '#9f8c76',
    pastelColor: '#e3dac9',
    description: 'Daily lessons from our canine companions - celebrating loyalty, unconditional love & living in the moment',
    price: 9.99,
    textColor: '#000000',
  },
  threadsOfConnection: {
    ...
    buttonColor: '#c35817',
    pastelColor: '#fbd5ab',
    description: '365 Days affirming Human connection, being part of a global community, & the ways we touch each other\'s lives',
    price: 9.99,
    textColor: '#FFFFFF',
  },
};
